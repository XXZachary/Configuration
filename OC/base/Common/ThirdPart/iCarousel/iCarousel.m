...
- (int)commitTranslation:(CGPoint)translation {
    ...
    int direction = 0; //1 左, 2 右, 3 上, 4 下
    
    // 设置滑动有效距离
    if (MAX(absX, absY) < 10) return direction;
...
//                [_delegate carouselDidScroll:self direction:[self commitTranslation:[panGesture translationInView:self]]];
