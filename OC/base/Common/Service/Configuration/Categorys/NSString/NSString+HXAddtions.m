...
+(void)jsonTest{
    ...
    NSDictionary *dictionary = [NSDictionary dictionaryWithObjectsAndKeys:
                                ...
                                nil];
    XXZLog(@"dictionary:%@",dictionary);
    NSString *jsonString = [NSString jsonStringWithObject:dictionary];
    XXZLog(@"dictionary jsonString:%@",jsonString);
    
    //XXZLog(@"%@",[NSDictionary dictionaryWithData:[jsonString dataUsingEncoding:NSUTF8StringEncoding]]);
